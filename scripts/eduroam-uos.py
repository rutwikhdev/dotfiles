...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "University of Surrey"
Config.profilename = "eduroam for University of Surrey"
Config.url = "https://support.surrey.ac.uk"
Config.email = "itservicedesk@surrey.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "eduroamauth.surrey.ac.uk"
...
Config.user_realm = "surrey.ac.uk"
Config.ssids = ['eduroam']
Config.del_ssids = ['GUEST_WIFI']
Config.servers = ['DNS:eduroamauth.surrey.ac.uk']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
